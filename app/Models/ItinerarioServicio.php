...
class ItinerarioServicio extends Model
{
    ...
    protected $fillable = ['nro_orden', 'hora', 'itinerario_servicio_id', 'servicio_id', 'itinerario_destino_id', 'proveedor_categoria_id', 'proveedor_id', 'observacion', 'precio_id', 'moneda', 'monto', 'estado_activo'];
