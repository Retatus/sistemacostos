    ...
    public function rules(): array
    {
        return [
            ...
            "ruc" => [
                ...
                Rule::when(intval($this->input('tipo_documento_id')) == 1, ['string:8', 'bail']),  // DNI (8 dígitos)
                Rule::when(intval($this->input('tipo_documento_id')) == 2, ['string:11', 'bail']), // RUC (11 dígitos)
                Rule::when(intval($this->input('tipo_documento_id')) == 3, ['regex:/^[A-Za-z0-9]{6,12}$/', 'bail']), // PASAPORTE (6 a 12 caracteres alfanuméricos)
            ],
