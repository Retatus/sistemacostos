                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tr v-for="(item, index) in ListaPasajeros" :key="index" className="bg-white border-b text-gray-900">
                        <td class="px-4 py-2 text-sm">
                            <input v-model="item.nombre" type="text" required="true" class="mt-1 w-full border-gray-300 rounded-md shadow-sm" />
                        </td>
                        <td class="px-4 py-2 text-sm">
                            <input v-model="item.apellido_paterno" type="text" required="true" class="mt-1 w-full border-gray-300 rounded-md shadow-sm" />
                        </td>
                        <td class="px-4 py-2 text-sm">
                            <input v-model="item.apellido_materno" type="text" required="true" class="mt-1 w-full border-gray-300 rounded-md shadow-sm" />
                        </td>                        
                        <td class="px-4 py-2 text-sm">
                            <select v-model="item.documento_tipo_id" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                        ...
                        <td class="px-4 py-2 text-sm">
                            <input v-model="item.documento_numero" type="text" required="true" class="mt-1 w-full border-gray-300 rounded-md shadow-sm" />
                        </td>                    
                        <td class="px-4 py-2 text-sm">
                            <select v-model="item.pais_id" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                                <option disabled value="">-- Selecciona una opción --</option>
                        ...
                        <td class="px-4 py-2 text-sm">                            
                            ...
                            <div class="flex items-center space-x-2">                               
                                <input v-model="item.documento_file" type="text" required="true" class="mt-1 w-full border-gray-300 rounded-md shadow-sm" />
                        ...
                        <td class="px-4 py-2 text-sm">
                            <select v-model="item.clase_id" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
                                <option disabled value="">-- Selecciona una opción --</option>
...
const handleFileChange = (event, index) => {
    ...
    props.ListaPasajeros[index].documento_file = archivo.name;
};
