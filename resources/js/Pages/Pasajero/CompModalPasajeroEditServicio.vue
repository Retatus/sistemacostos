                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                        <thead className="text-xs text-gray-900 uppercase bg-gray-50">
                            <tr class="bg-gray-100">
                                <th colspan="3" class="w-1/12 px-4 py-2 text-sm font-medium">Nombre de pax</th>
                                <th class="w-1/12 px-4 py-2 text-sm font-medium">Tipo Doc</th>
                                <th class="w-1/12 px-4 py-2 text-sm font-medium">Nro Doc</th>
                                <th class="w-3/12 px-4 py-2 text-sm font-medium">Tarifa</th>
                                <th class="w-1/12 px-4 py-2 text-sm font-medium">Tipo Pax</th>
                                <th class="w-1/12 px-4 py-2 text-sm font-medium">Categoria </th>
