...
<script setup>
   import { ref } from 'vue';
    ...
    const page = usePage();
    const pasajero = page.props.pasajero;
    ...
    const onSelectFile = (e) => {
        ...
        if (urlImagen.value) {
            URL.revokeObjectURL(urlImagen.value); // Liberar memoria de la imagen anterior
        }
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                                    <div class="w-full  grid grid-cols-1 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <!-- Mostrar imagen de la base de datos si no se ha seleccionado una nueva -->
                                            <img v-else-if="pasajero.documento_file" :src="`/storage/${pasajero.documento_file}`" class="h-20 w-20 object-cover mt-2" />
                                        </div>
                                        <div>
