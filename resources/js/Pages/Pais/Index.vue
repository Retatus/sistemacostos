<script setup>
    ...
    const onDeleteConfirm = (Pais) => {
        Swal.fire({
            ...
            html: `Este elemento <strong>${Pais.nombre}</strong> será eliminado permanentemente.`,
            icon: 'warning',
            ...
            router.delete(route('pais.destroy', Pais), {
                onSuccess: (page) => {
                Paiss.value = page.props.paiss;
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div className="relative overflow-y-auto">
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                                <tr v-for="pais in Paiss" className="bg-white border-b ">
