<script setup>
    ...
    const onDeleteConfirm = (ProveedorCategoria) => {
        Swal.fire({
            title: '<strong>¿Estás seguro?</strong>',
            html: `Este elemento <strong>${ProveedorCategoria.nombre}</strong> será eliminado permanentemente.`,
            icon: 'warning',
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div className="relative overflow-y-auto">
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                                <tr v-for="proveedorcategoria in ProveedorCategorias" className="bg-white border-b ">
                                    ...
                                    <td scope="col" className="px-6 py-4 font-medium text-gray-900">
                                        <div class="flex space-x-2">
                                            ...
                                            <button @click="onDeleteConfirm(proveedorcategoria)">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
