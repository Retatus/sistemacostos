...
<script setup>
    ...
    console.log(props);
    const form = useForm({
        nombre: props.tipoComprobante.nombre,
        estado_activo: props.tipoComprobante.estado_activo,
    });
    ...
    <AppLayout title="Dashboard">
        <template #header>
          <div class="flex justify-between">
              ...
              <Link :href="route('tipo_comprobante')" class="btn btn-primary"> <i class="bi bi-plus"></i>
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex justify-center overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <FormularioDinamico
                        ...
                        :fields="formFields"                            
                        :updating="true"
                        @submit="form.patch(route('tipo_comprobante.update', tipoComprobante))" 
                    />
                </div>
            </div>
        </div>
