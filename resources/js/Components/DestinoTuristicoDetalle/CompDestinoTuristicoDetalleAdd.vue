      ...
      <table className="w-full text-sm text-left rtl:text-right text-gray-500">
        <thead className="text-xs text-gray-900 uppercase bg-gray-50">
          <tr class="bg-gray-100">
            ...
            <th class="w-1/12 px-4 py-2 text-sm font-medium">Itinerario</th>
            <th class="w-1/12 px-4 py-2 text-sm font-medium">Servicio</th>
            <th class="w-1/12 px-4 py-2 text-sm font-medium">Acciones</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="(item, index) in Lista_destino_turistico_detalle" :key="index" className="bg-white border-b text-gray-900">
    ...
    <Modal :show="isModalVisible" maxWidth="70" closeable @close="closeModal">
      <div class="p-4">
          <CompDestinoTuristicoDetalleServicio
              ...
              :Lista_servicio_clase="Lista_servicio_clase"
              :Lista_servicio_detalle="Lista_servicio_detalle"
              @update="updateDestinoTuristicoDetalleServicio"
          />
          <button
              @click="closeModal"
...
<script setup>
    ...
    import CompDestinoTuristicoDetalleServicio from '../DestinoTuristicoDetalleServicio/CompDestinoTuristicoDetalleServicio.vue';
